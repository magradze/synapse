 ...
 * @brief BLE-based WiFi provisioning service
 * @author Synapse Framework Team
 * @version 1.0.0
 * @details Ble_Provisioning მოდული რომელიც აღზევს BLE-based WiFi provisioning service ფუნქციონალურობას.
...
/**
 * @brief Ble_Provisioning მოდულის კონფიგურაციის სტრუქტურა
...
} ble_provisioning_config_t;

/**
 * @brief ქმნის ახალ ble_provisioning მოდულის ინსტანციას
 * 
