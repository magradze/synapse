...
Core წარმოადგენს ფრეიმვორქის ბირთვს და უზრუნველყოფს მოდულებს შორის იზოლირებულ, სტანდარტიზებულ და უსაფრთხო ურთიერთქმედებას. ყველა ინფრასტრუქტურული სერვისი და მექანიზმი თავმოყრილია core-ში, რაც უზრუნველყოფს სისტემის სტაბილურობასა და გაფართოებადობას.
...
### 4. Module Factory (ყოფილი Fabrique)
...
შემდეგი ნაბიჯი: დეტალურად განვიხილოთ კონფიგურაციის მართვის პროცესი და სტრუქტურა.
