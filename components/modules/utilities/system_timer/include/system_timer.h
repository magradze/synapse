/**
 * @file system_timer.h
 * @brief A centralized service for scheduling events.
 * @author Synapse Framework Team
 * @version 1.0.0
 * @details System Timer მოდული რომელიც აღზევს A centralized service for scheduling events. ფუნქციონალურობას.
...
/**
 * @brief System Timer მოდულის კონფიგურაციის სტრუქტურა
...
/**
 * @brief ქმნის ახალ system_timer მოდულის ინსტანციას
 * 
