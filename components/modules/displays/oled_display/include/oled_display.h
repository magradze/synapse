 ...
 * @version 1.0.0
 * @details Oled_Display მოდული რომელიც აღზევს OLED display driver ფუნქციონალურობას.
...
/**
 * @brief Oled_Display მოდულის კონფიგურაციის სტრუქტურა
...
/**
 * @brief ქმნის ახალ oled_display მოდულის ინსტანციას
 * 
